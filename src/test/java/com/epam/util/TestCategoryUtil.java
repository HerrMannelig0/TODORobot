...
public class TestCategoryUtil {
	...
	public void testGeneratingMapFromLibrary() throws Exception {
		...
		book1.setBookCategory("Romance");
		book2.setBookCategory("Romance");
		book3.setBookCategory("Horror");
		...
		Map<String, List<Book>> map = CategoryUtil.generateMapFromAllBooksLibrary(library);
